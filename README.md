...
## Update
- 2025-03-02: We support LoRA Fine-tuning for GRPO. See [run_grpo_rec_lora.sh](src/open-r1-multimodal/scripts/run_grpo_rec_lora.sh) for details.
...
- 2025-02-25: We support multi-node training for GRPO. See [multinode_training_demo.sh](src/open-r1-multimodal/scripts/multinode_training_demo.sh) for details.
