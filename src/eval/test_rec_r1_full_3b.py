...
steps = 500
print("Steps: ", steps)
MODEL_PATH=f"/home/ec2-user/VLM-R1/src/open-r1-multimodal/output/Qwen2.5-VL-3B-GRPO-REC/checkpoint-{steps}" 
OUTPUT_PATH="./logs/rec_results_qwen2_5vl_full_3b_r1_{STEPS}.json"
BSZ=8
