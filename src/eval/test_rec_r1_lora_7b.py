...
steps = 500
print("Steps: ", steps)
MODEL_PATH=f"/home/ec2-user/VLM-R1/src/open-r1-multimodal/output/Qwen2.5-VL-7B-GRPO-REC-lora/checkpoint-{steps}" 
OUTPUT_PATH="./logs/rec_results_qwen2_5vl_lora_7b_r1_{STEPS}.json"
BSZ=8
